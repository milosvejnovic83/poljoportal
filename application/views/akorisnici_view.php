...
<head>
	...
	<title>Admin Korisnici Page | Poljoportal.com</title>
...
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-sm-6">
			<h4>Korisnici</h4>
			<a href="<?php echo base_url(); ?>index.php/ksignup">Dodaj novog korisnika</a>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($userlist); ++$i) { ?>
                            <tr>
								...
								<td><a href="<?php echo base_url() . "index.php/kprofile/user/" . $userlist[$i]->id; ?>">Detaljnije</a></td>
								<td><a href="<?php echo base_url() . "index.php/aupdatekorisnik/index/" . $userlist[$i]->id; ?>">Izmeni</a></td>
								<td><a href="<?php echo base_url() . "index.php/akorisnici/deleteUser/" . $userlist[$i]->id; ?>">Obrisi</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
