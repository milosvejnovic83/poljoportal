...
<head>
	...
	<title>Admin Izmena Teksta Page | Poljoportal.com</title>
...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-md-offset-3 well">
			...
			echo form_open("aupdatetekst/index/".$id, $attributes);?>
			<legend>Oglas</legend>
			<div style="display:none;" class="form-group">
				<label for="id">ID</label>
				<input class="form-control" name="id"  placeholder="id" type="text" value="<?php echo set_value('id', $text[0]->id); ?>" />
				<span class="text-danger"><?php echo form_error('id'); ?></span>
			</div>		
			<div class="form-group">
				<label for="name">Naslov</label>
				<input class="form-control" name="title" placeholder="Naslov" type="text" value="<?php echo set_value('title', $text[0]->title); ?>" />
				<span class="text-danger"><?php echo form_error('title'); ?></span>
			</div>			
			<div class="form-group">
				<label for="text">Tekst</label>
				<input class="form-control" rows="10" col="5" name="text" placeholder="Tekst" type="textarea" value="<?php echo set_value('text', $text[0]->text); ?>" />
